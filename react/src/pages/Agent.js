    ...
    const columns = [
        ...
        },
        {
            ...
            renderCell: (params) => {
                ...
                let tokenID = localStorage.getItem("secure-id");
                return <>{(tokenID==1)?<><Button onClick={Delete}><IconButton><DeleteIcon /></IconButton></Button><Link href={"agent/"+params.id}><IconButton><EditIcon /></IconButton></Link></>:""}</>;
            }
        }
    ];
